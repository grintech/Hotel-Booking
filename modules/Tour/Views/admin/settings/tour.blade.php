...
<div class="row">
    <div class="col-sm-4">
        ...
        <p class="form-group-desc">{{__('Config review for guided tour')}}</p>
    </div>
    <div class="col-sm-8">
        <div class="panel">
            <div class="panel-body">
                <div class="form-group">
                    <label class="" >{{__("Enable review system for Guided Tour?")}}</label>
                    <div class="form-controls">
                ...
                <div class="form-group" data-condition="tour_enable_review:is(1)">
                    <label class="" >{{__("Customer must book a guided tour before writing a review?")}}</label>
                    <div class="form-controls">
...
@if(is_default_lang())
    ...
    <div class="row">
        <div class="col-sm-4">
            ...
            <p class="form-group-desc">{{__('Config buyer fees for guided tour')}}</p>
        </div>
        <div class="col-sm-8">
            <div class="panel">
                <div class="panel-body">
    ...
    <div class="row">
        ...
        <div class="col-sm-8">
            <div class="panel">
                <div class="panel-body">
                    <div class="form-group">
                        <label class="" >{{__("Guided Tour create by vendor must be approved by admin?")}}</label>
                        <div class="form-controls">
...
<div class="row">
    <div class="col-sm-4">
        ...
        <p class="form-group-desc">{{__('Config sidebar for Guided Tour')}}</p>
    </div>
    <div class="col-sm-8">
        <div class="panel">
            <div class="panel-body">
                    ...
                    <div class="form-controls">
                        <div class="form-group-item">
                            ...
                            <div class="g-items">
                                <?php
                                $social_share = [];
                                if(!empty($settings['tour_sidebar'])){
                                $social_share  = $settings['tour_sidebar'];

                                $social_share = json_decode(setting_item_with_lang('tour_sidebar',request()->query('lang'),$settings['tour_sidebar'] ?? "[]"));
                                ?>
                                @foreach($social_share as $key=>$item)
                                    <div class="item" data-number="{{$key}}">
                                        <div class="row">
                                            <div class="col-md-8">
                                                <input type="text" name="tour_sidebar[{{$key}}][title]" class="form-control" placeholder="{{__('Title: About Us')}}" value="{{$item->title}}">
                                                <textarea name="tour_sidebar[{{$key}}][content]" rows="2" class="form-control" placeholder="{{__("Content")}}">{{$item->content}}</textarea>
                                            </div>
                                            <div class="col-md-3">
                                                <select class="form-control" name="tour_sidebar[{{$key}}][type]">
                            ...
                            <div class="g-more hide">
                                <div class="item" data-number="__number__">
                                    <div class="row">
                                        <div class="col-md-8">
                                            <input type="text" __name__="tour_sidebar[__number__][title]" class="form-control" placeholder="{{__('Title: About Us')}}">
                                            <textarea __name__="tour_sidebar[__number__][content]" rows="3" class="form-control" placeholder="{{__("Content")}}"></textarea>
                                        </div>
                                        <div class="col-md-3">
                                            <select class="form-control" __name__="tour_sidebar[__number__][type]">
...
<div class="row">
    <div class="col-sm-4">
        <h3 class="form-group-title">{{__("Disable guided tour module?")}}</h3>
    </div>
    <div class="col-sm-8">
        <div class="panel">
            <div class="panel-title"><strong>{{__("Disable guided tour module")}}</strong></div>
            <div class="panel-body">
                <div class="form-group">
                    <div class="form-controls">
