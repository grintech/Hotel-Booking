@extends('layouts.app')
@section('head')
    <link href="{{ asset('dist/frontend/module/space/css/space.css?v='.config('asset.space.css')) }}" rel="stylesheet">
...
@section('footer')
    ...
    <script type="text/javascript" src="{{ asset('module/space/js/single-space.js?v='.config('asset.space.js')) }}"></script>
@endsection
