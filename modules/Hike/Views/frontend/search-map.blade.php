    ...
    <div class="bravo_search_tour">
        ...
        <div class="bravo_search_map {{ setting_item_with_lang("hike_layout_map_option",false,"map_left") }}">
            ...
            <div class="results_item">
                @include('Hike::frontend.layouts.search-map.advance-filter')
                <div class="listing_items">
                    @include('Hike::frontend.layouts.search-map.list-item')
                </div>
            </div>
        </div>
    </div>
...
@section('footer')
    ...
    <script type="text/javascript" src="{{ asset('module/hike/js/tour-map.js?_ver='.config('asset.hike.js')) }}"></script>
@endsection
