            ...
            <div class="form-wrapper">
                ...
                <form action="{{ route('review.store') }}" class="needs-validation" novalidate method="post">
                    ...
                    <div class="row">
                        ...
                        @if($hike_review_stats = setting_item("hike_review_stats"))
                            @php $hike_review_stats = json_decode($hike_review_stats) @endphp
                            <div class="col-xs-12 col-md-4">
                                <div class="form-group review-items">
                                    @foreach($hike_review_stats as $item)
                                        <div class="item">
                    ...
                    <div class="text-center">
                        ...
                        <input type="hidden" name="review_service_type" value="hike">
