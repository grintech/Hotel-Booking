...
use Modules\Guesthouse\Models\GuesthouseRoomBooking;
use Modules\Guesthouse\Models\GuesthouseRoomDate;

class AvailabilityController extends FrontendController{

    protected $roomClass;
    /**
     * @var GuesthouseRoomDate
     */
    ...
    protected $indexView = 'Guesthouse::frontend.user.availability';
    ...
    public function index(Request $request,$guesthouse_id){
        ...
        $q->orderBy('id','desc');
        $q->where('parent_id',$guesthouse_id);
        ...
        return view($this->indexView,compact('rows','breadcrumbs','current_month','page_title','request','guesthouse'));
    }

    public function loadDates(Request $request,$guesthouse_id){
...
//                    }
    ...
    public function store(Request $request,$hotel_id){
        ...
        if(!$this->hasGuesthousePermission($hotel_id))
        {
            return $this->sendError(__("Guesthouse not found"));
        }
        ...
        if(!$this->hasPermission('hotel_manage_others')){
            ...
            if($this->currentGuesthouse->create_user != Auth::id()){
