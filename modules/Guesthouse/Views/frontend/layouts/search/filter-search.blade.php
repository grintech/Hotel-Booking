        ...
        <div class="g-filter-item">
            ...
            <div class="item-content">
                <div class="bravo-filter-price">
                    <?php
                    $price_min = $pri_from = floor ( App\Currency::convertPrice($guesthouse_min_max_price[0]) );
                    $price_max = $pri_to = ceil ( App\Currency::convertPrice($guesthouse_min_max_price[1]) );
