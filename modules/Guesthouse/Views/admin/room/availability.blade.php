    ...
    <script>
        ...
        $('#items_tab').on('show.bs.tab',function (e) {
			...
			calendar = new FullCalendar.Calendar(calendarEl, {
				...
				events:{
                    	url:"{{route('guesthouse.admin.room.availability.loadDates',['guesthouse_id'=>$guesthouse->id])}}",
						extraParams:{
							id:lastId,
                        }
                },
        ...
        formModal = new Vue({
            ...
            methods:{
                ...
                saveForm:function () {
                    ...
                    $.ajax({
                        url:'{{route('guesthouse.admin.room.availability.store',['guesthouse_id'=>$guesthouse->id])}}',
                        data:this.form,
                        dataType:'json',
                        method:'post',
