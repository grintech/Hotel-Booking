                ...
                <div class="form-group">
                    ...
                    <div class="form-controls">
                        <select name="hotel_layout_map_option" class="form-control">
                            <option {{ (setting_item_with_lang('guesthouse_layout_map_option',request()->query('lang')) ?? '') == 'map_left' ? 'selected' : '' }} value="map_left">{{__('Map Left')}}</option>
                            <option {{ (setting_item_with_lang('guesthouse_layout_map_option',request()->query('lang')) ?? '') == 'map_right' ? 'selected' : ''  }} value="map_right">{{__("Map Right")}}</option>
                        </select>
                    </div>
                </div>
                @if(is_default_lang())
                    <div class="form-group">
                        ...
                        <div class="form-controls">
                            <input type="number" min="1" name="guesthouse_page_limit_item" placeholder="{{ __("Default: 9") }}" value="{{setting_item_with_lang('guesthouse_page_limit_item',request()->query('lang'), 9)}}" class="form-control">
                        </div>
                    </div>
                <div class="row">
                    <div class="col-md-6">
                ...
                <div class="form-group">
                    ...
                    <div class="form-controls">
                        <select name="guesthouse_location_search_style" class="form-control">
                            ...
                            <option {{ ($settings['guesthouse_location_search_style'] ?? '') == 'autocompletePlace' ? 'selected' : '' }} value="autocompletePlace">{{__('Autocomplete from Gmap Place')}}</option>
                        </select>
                    </div>
                </div>
                @endif
                                ...
                                @foreach($guesthouse_booking_buyer_fees as $key=>$buyer_fee)
                                    <div class="item" data-number="{{$key}}">
                                        <div class="row">
                                            ...
                                            <div class="col-md-3">
                                                <input type="number" min="0" step="0.1"  name="guesthouse_booking_buyer_fees[{{$key}}][price]" class="form-control" value="{{$buyer_fee['price']}}">
                        ...
                        <div class="g-more hide">
                            <div class="item" data-number="__number__">
                                <div class="row">
                                    ...
                                    <div class="col-md-3">
                                        <input type="number" min="0" step="0.1"  __name__="guesthouse_booking_buyer_fees[__number__][price]" class="form-control" value="">
            ...
            <div class="panel">
                <div class="panel-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="form-controls">
                            <label><input type="checkbox" name="guesthouse_allow_vendor_can_change_paid_amount" value="1" @if(!empty($settings['guesthouse_allow_vendor_can_change_paid_amount'])) checked @endif /> {{__("Yes please")}} </label>
                            <br>
