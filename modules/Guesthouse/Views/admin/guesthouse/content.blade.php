<div class="panel">
    <div class="panel-title"><strong>{{__("Guesthouse Content")}}</strong></div>
    <div class="panel-body">
        <div class="form-group">
            <label>{{__("Title")}}</label>
            <input type="text" value="{!! clean($translation->title) !!}" placeholder="{{__("Name of the guesthouse")}}" name="title" class="form-control">
        </div>
        <div class="form-group">
...
<div class="panel">
    <div class="panel-title"><strong>{{__("Guesthouse Policy")}}</strong></div>
    <div class="panel-body">
        @if(is_default_lang())
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        <label>{{__("Guesthouse rating standard")}}</label>
