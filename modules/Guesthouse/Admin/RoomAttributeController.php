...
class RoomAttributeController extends AdminController
{
    ...
    public function index(Request $request)
    {
        ...
        $listAttr = $this->attributesClass::where("service", 'guesthouse_room');
        ...
        return view('Guesthouse::admin.room.attribute.index', $data);
    }
    ...
    public function edit(Request $request, $id)
    {
        ...
        $data = [
            ...
            'rows'        => $this->attributesClass::where("service", 'guesthouse_room')->get(),
            'row'         => $row,
            'breadcrumbs' => [
                [
                    'name' => __('Guesthouse'),
        ...
        return view('Guesthouse::admin.room.attribute.detail', $data);
    }
    ...
    public function terms(Request $request, $attr_id)
    {
        ...
        return view('Guesthouse::admin.terms.index', $data);
    }
    ...
    public function term_edit(Request $request, $id)
    {
        ...
        $data = [
            ...
            'breadcrumbs' => [
                ...
                [
                    'name' => $attr->name,
                    'url'  => 'admin/module/guesthouse/room/attribute/terms/' . $row->attr_id
                ],
                [
        ...
        return view('Guesthouse::admin.terms.detail', $data);
    }
    ...
    public function getForSelect2(Request $request)
    {
        ...
        if($pre_selected && $selected){
            ...
            {
                $query = $this->termsClass::getForSelect2Query('guesthouse_room');
        ...
        $q = $request->query('q');
        $query = $this->termsClass::getForSelect2Query('guesthouse_room',$q);
