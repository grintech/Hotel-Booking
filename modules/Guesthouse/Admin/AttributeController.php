...
class AttributeController extends AdminController
{
    ...
    public function index(Request $request)
    {
        ...
        $listAttr = $this->attributesClass::where("service", 'guesthouse');
        ...
        return view('Guesthouse::admin.attribute.index', $data);
    }
    ...
    public function edit(Request $request, $id)
    {
        ...
        $data = [
            ...
            'rows'        => $this->attributesClass::where("service", 'guesthouse')->get(),
            'row'         => $row,
            'breadcrumbs' => [
                [
                    'name' => __('Guesthouse'),
        ...
        return view('Guesthouse::admin.attribute.detail', $data);
    }
    ...
    public function term_edit(Request $request, $id)
    {
        ...
        $data = [
            ...
            'breadcrumbs' => [
                ...
                [
                    'name' => $attr->name,
                    'url'  => 'admin/module/guesthouse/attribute/terms/' . $row->attr_id
                ],
                [
    ...
    public function getForSelect2(Request $request)
    {
        ...
        if($pre_selected && $selected){
            ...
            {
                $query = $this->termsClass::getForSelect2Query('guesthouse');
        ...
        $q = $request->query('q');
        $query = $this->termsClass::getForSelect2Query('guesthouse',$q);
    ...
    {
        $q = $request->query('q');
        $query = $this->attributesClass::selectRaw("id,name as text")->where('service','guesthouse');
        if ($q) {
