...
class GuesthouseRoom extends Bookable
{
    use SoftDeletes;
    ...
    protected $seo_type = 'guesthouse_room';
    ...
    public function __construct(array $attributes = [])
    {
        ...
        $this->roomDateClass = GuesthouseRoomDate::class;
        $this->guesthouseRoomTermClass = GuesthouseRoomTerm::class;
        $this->roomBookingClass = GuesthouseRoomBooking::class;
    }
...
//                {
    ...
    {
       return $this->roomBookingClass::query()->where('room_id',$this->id)->active()->inRange($from,$to)->get(['bravo_guesthouse_room_bookings.*']);
    }
