...
class GuesthouseRoomBooking extends Bookable
{
    protected $table = 'bravo_guesthouse_room_bookings';
    ...
    public function scopeInRange($query,$start,$end){
        $query->where('bravo_guesthouse_room_bookings.start_date','<=',$end)->where('bravo_guesthouse_room_bookings.end_date','>',$start);
    }
    ...
    public function room(){
        return $this->hasOne(GuesthouseRoom::class,'id','room_id')->withDefault();
    }
