...
class RouterServiceProvider extends ServiceProvider
{
     ...
     * @var string
     */
    protected $moduleNamespace      = 'Plugins\GPGCheckout\Controllers';
    protected $adminModuleNamespace = 'Plugins\GPGCheckout\Admin';
    ...
    protected function mapAdminRoutes()
    {
        Route::middleware([
            'web',
            'dashboard'
        ])->namespace($this->adminModuleNamespace)->prefix('admin/module/GPGCheckout')->group(__DIR__ . '/Routes/admin.php');
    }
